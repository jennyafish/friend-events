            ...
            return(
                <div className="events-grid">
                    <Card shadow={10} style={{maxwidth: '600px', margin: 'auto'}}>
                        ...
                        <CardText>
                             Catch a Steeler's game at Ford Field <br/>
                            Feb 16, 3pm EST
                        </CardText>
                    ...
                    <Card shadow={10} style={{minwidth: '600px', margin: 'auto'}}>
                        ...
                        <CardText>
                            Catch a Panther's game at Ford Field <br/>
                            Feb 14, 8pm EST
                        </CardText>
                        <CardActions border>
                            <Button colored>Join Event</Button>
            ...
            return(
                <div className="events-grid">
                    <Card shadow={10} style={{maxwidth: '600px', margin: 'auto'}}>
                        ...
                        <CardText>
                            Watch people perform at the outdoor sports show! <br/>
                            Feb 15, 3:30pm EST
            ...
            return(
                <div className="events-grid">
                    ...
                    <Card shadow={10} style={{minwidth: '512px', margin: 'auto'}}>
                        ...
                        <CardText>
                           Watch Parasite at Star Theatre!
                        </CardText>
